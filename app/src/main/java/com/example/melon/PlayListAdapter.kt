...
class PlayListAdapter(private  val callback: (MusicModel)->Unit) : ListAdapter<MusicModel, PlayListAdapter.ViewHolder>(diffDutil){
    ...
    companion object {
        val diffDutil = object : DiffUtil.ItemCallback<MusicModel>() {
